...
<div class='navCart'>
    <div id='navBlock'>
        <div id='curNav'><a href='orders.php' style='text-decoration:none;'>Заказы</a></div>
...
<?php
    $id_user = $_SESSION['id'];
    $queryOrders = mysqli_fetch_all(mysqli_query($conn, "SELECT orders.* FROM users JOIN orders ON users.user_id=orders.order_user WHERE order_user=$id_user"));
    if ($queryOrders!=null) {echo "<div id='rowOrder' class='rowOrderForORDERS'>";
        ...
        echo  "</div>";
     $i=1;
        foreach ($queryOrders as $orders) {$i++; 
