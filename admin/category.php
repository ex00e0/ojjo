...
<div class='navCartSpUsers'>
    <div id='navBlock'>
        <div><a href='index.php' style='text-decoration:none;'>Товары</a></div>
        <div><a href='users.php' style='text-decoration:none;'>Пользователи</a></div>
        <div id='curNav'><a href='category.php' style='text-decoration:none;'>Категории</a></div>
    ...
    // if ($order_no) {echo "<div id='rowOrder'><div class='headline'>Заказ № $order_no</div></div>";}
        ...
        if ($queryJewAdm!=null) {
         ...
         echo "<script> let numRows = document.getElementById('orderContent');
            ...
            echo "<form action='category.php' method='get' id='formSearch'>";
            ...
            foreach ($queryJewAdm as $cats) { if ($cats[2]=='deleted') {$class_st='classDeleted';
                ...
                echo "<form id='rowOrder' class='rowOrderFORCATEGORY' method='post' action='checkCatEdit.php'>";
                                                                    ...
                                                                    if ($cats[2]=='deleted') {echo "<a href='preEditCatStatus.php?edit_cat=recover&id_cat=$cats[0]' class='aDelRec'><img src='../recover.png' class='buttonRecover'></a>";}
                                                                    else {echo "<a href='preEditCatStatus.php?edit_cat=delete&id_cat=$cats[0]'><img src='../delete.png' class='buttonDelete'></a>";}
                                                                    echo  "</form>";} }
            ...
            echo "</form>";
            echo "<div id='buttonCreateJew' data-bs-toggle='modal' data-bs-target='#exampleModal'>Добавить новую категорию</div>";
             echo "<p id='empty' style='grid-row:2; grid-column:1/4;'>Пока пусто..</p> </div>"; }
    ?>
</div>
</div>
